...
namespace Dyslexword.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult ComprobarTutor(string userId)
        {
            AlumnoTutor alumnoTutor = db.AlumnoTutors.FirstOrDefault(l => l.UserAlumnoId == userId);
            string iduserTutor = null;
            if (alumnoTutor != null)
            {
                iduserTutor = alumnoTutor.UserTutorId;
            }


            return Content(iduserTutor); // Devolvemos el resultado como una respuesta de contenido
        }

        public ActionResult ComprobarAlumno(string userId)
        {
            AlumnoTutor alumnoTutor = db.AlumnoTutors.First(l => l.UserTutorId == userId);

            return Content(alumnoTutor.UserAlumnoId); // Devolvemos el resultado como una respuesta de contenido
        }
